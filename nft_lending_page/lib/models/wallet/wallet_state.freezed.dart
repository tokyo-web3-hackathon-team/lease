...
class _$WalletStateCopyWithImpl<$Res, $Val extends WalletState>
  ...
  @override
  $Res call({
    Object? loginAddress = null,
  }) {
    return _then(_value.copyWith(
      loginAddress: null == loginAddress
          ? _value.loginAddress
...
class _$_WalletState implements _WalletState {
  const _$_WalletState({this.loginAddress = ""});
  ...
  @override
  String toString() {
    return 'WalletState(loginAddress: $loginAddress)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, loginAddress);
...
abstract class _WalletState implements WalletState {
  const factory _WalletState({final String loginAddress}) = _$_WalletState;
